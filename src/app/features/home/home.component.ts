    ...
    <section id="skills" class="section skills-section" @staggerCards>
      <div class="container">
        <div class="skills-header-wrap">
          ...
          <p class="section-heading-desc">
            Full-stack engineering stack refined across 7 years of building high-throughput microservices, scalable SaaS, and conversational voice AI.
          </p>
        </div>
    ...
    <section id="contact" class="section contact-section">
      <div class="container">
        <div class="contact-header-wrap">
          ...
          <p class="section-heading-desc">
            Available for Senior Full Stack, AI SaaS, and Microservices leadership. Reach out directly or submit a message below.
          </p>
        </div>
